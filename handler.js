...
export async function handler(chatUpdate) {
   ...
   Your Devs Friend Monster-Bunny
   */
...
export async function participantsUpdate({ id, participants, action }) {
    ...
    switch (action) {
        ...
        case 'remove':
            if (chat.swagat) {
                ...
                for (let user of participants) {
                    let pp = 'https://i.ibb.co/wsTPjTQ/donate.jpg'
                    let ppgp = 'https://i.ibb.co/wsTPjTQ/donate.jpg'
                    try {
        ...
        case 'demote':
            let pp = await this.profilePictureUrl(participants[0], 'image').catch(_ => 'https://i.ibb.co/wsTPjTQ/donate.jpg') 
            if (!text)
